...
import MockupImage02 from '@/public/images/sponsers/01.jpg'
import MockupImage03 from '@/public/images/sponsers/02.jpg'
import MockupImage04 from '@/public/images/sponsers/03.jpg'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display mb-4">Sponsers and partners</h2>
