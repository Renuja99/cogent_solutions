...
import CarouselImage01 from '@/public/images/speakers/1.jpg'
import CarouselImage02 from '@/public/images/speakers/2.jpg'
import CarouselImage03 from '@/public/images/speakers/3.jpg'
import CarouselImage04 from '@/public/images/speakers/4.jpg'
import CarouselImage05 from '@/public/images/speakers/5.jpg'
      ...
      <div className="py-12 md:py-20">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 font-red-hat-display mb-4">Our Speakers</h1>
            <p className="text-xl text-gray-600 dark:text-gray-400">Corporate tax (CT) is a form of direct tax levied on the net income or profit of corporations and other entities from their business. Corporate Tax is sometimes also referred to as “Corporate Income Tax (CIT)” or “Business Profits Tax” in other jurisdictions.</p>
          </div>
